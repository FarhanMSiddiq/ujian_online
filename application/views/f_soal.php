    ...
    <div class="row">
      <div class="col-md-12">
          ...
          <div id="konfirmasi"></div>
            ...
            <div class="form-group fgsoal">
              <div class="col-md-3"><label>Kunci Jawaban</label></div>
              <div class="col-md-5">
              ...
              <div class="col-md-3"><label>Bobot Nilai Soal</label></div>
              <div class="col-md-3"><input type="text" name="bobot" class="form-control" required value="<?php echo $d['bobot']; ?>"></div>
            </div>
